...
var useDatePicker = function useDatePicker(daysShort, monthNames, monthShortName) {
  ...
  var _useState = React.useState(today),
...
var PopUp = function PopUp(props) {
  return props.trigger ? React__default.createElement("div", {
...
var DatePicker = function DatePicker(_ref) {
  ...
  var _useState4 = React.useState(todayFormatted),
  ...
  return React__default.createElement(React.Fragment, null, React__default.createElement("input", {
  ...
  }, [selectedDate.getFullYear()]), React__default.createElement("div", {
    className: styles.react_pick_date_second_heading
  }, React__default.createElement("span", null, getWeekDay()), React__default.createElement("span", null, ","), React__default.createElement("span", {
    className: styles.react_pick_date_marginLeft
  }, monthShortName[selectedDate.getMonth()] + " " + selectedDate.getDate())))), yearView ? React__default.createElement("div", {
    ...
    }, item === selectedDate.getFullYear() ? React__default.createElement("div", {
  ...
  }, monthNames[selectedDate.getMonth()] + " " + selectedDate.getFullYear()), React__default.createElement("div", {
  ...
  }))), React__default.createElement("tbody", null, Object.values(calendarRows).map(function (cols) {
    return React__default.createElement("tr", {
      className: styles.react_pick_date_tr,
      key: cols[0].date
    }, cols.map(function (col) {
      return col.date === dateForCondition ? React__default.createElement("td", {
        key: col.date
      }, React__default.createElement("div", {
      ...
      }, col.value)) : React__default.createElement("td", {
        key: col.date
      }, col.classes === 'same_month' ? React__default.createElement("div", {
        className: styles.react_pick_same_month,
        onClick: function onClick() {
          return dateClickHandler(col.date);
        }
      }, col.value) : React__default.createElement("div", {
  ...
  }, "CANCEL"), React__default.createElement("div", {
    className: styles.react_pick_date_button,
    onClick: okHandler
  }, "OK"))))));
};
...
//# sourceMappingURL=react-day-select.cjs.development.js.map
